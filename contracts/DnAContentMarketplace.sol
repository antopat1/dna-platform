...
contract DnAContentMarketplace is Ownable, ReentrancyGuard, IERC721Receiver {
        ...
        nonReentrant
    {
        ...
        // Se l'offerente ha già fatto un'offerta, aggiorna il suo importo
        ...
        // Aggiorna l'asta
        auction.highestBid = bidderData.amount;
        auction.highestBidder = msg.sender;
        
        emit NewBid(tokenId, msg.sender, bidderData.amount, block.timestamp);
    }
        ...
        nonReentrant
    {
        ...
        if (auction.highestBidder != address(0)) {
            ...
            // Marca il vincitore come rimborsato per evitare doppi rimborsi
            bidderInfo[tokenId][winner].refunded = true;
        ...
        nonReentrant
    {
        ...
        require(!auction.isActive, "Auction not ended");
        
        BidderInfo storage bidderData = bidderInfo[tokenId][msg.sender];
        require(bidderData.amount > 0, "No bid found");
