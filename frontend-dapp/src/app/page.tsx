...
// ======================= INIZIO SOLUZIONE =======================
// Importiamo il componente Player in modo dinamico, disabilitando il SSR.
// Questo dice a Next.js: "Non provare a renderizzare questo componente sul server,
// caricalo e renderizzalo solo nel browser."
      ...
      <section className="text-center py-20 px-4 max-w-4xl mx-auto flex flex-col items-center">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          ...
          {isConnected && isAuthor ? (
            <Link href="/dashboard/register-content" className="bg-transparent border-2 border-gray-400 hover:border-blue-400 text-gray-300 hover:text-blue-400 font-semibold py-3 px-8 rounded-full transition-colors">
              Crea il tuo NFT
            </Link>
          ) : isConnected ? (
