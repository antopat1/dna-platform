      ...
      for (let i = 0; i < tokenIdsToCheck.length; i++) {
        ...
        if (owner.toLowerCase() === address.toLowerCase()) {
          ...
          if (listingRes.status === 'success') {
            ...
            if (listing[3] && listing[0].toLowerCase() === address.toLowerCase()) {
               isRelevant = true;
               seller = listing[0];
          ...
          if (!isRelevant && auctionRes.status === 'success') {
            ...
            if (auction[7] && !auction[8]) {
              if (auction[0].toLowerCase() === address.toLowerCase() ||
                  (auction[4].toLowerCase() === address.toLowerCase() && auction[4] !== `0x${'0'.repeat(40)}`)
                ) {
                isRelevant = true;
                seller = auction[0];
                status = { 
